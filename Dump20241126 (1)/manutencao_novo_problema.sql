...
CREATE TABLE `problema` (
  ...
  `datetime_finalizado` datetime DEFAULT NULL,
  `quanto_gastou` decimal(10,2) DEFAULT NULL,
  `caminho_imagem` varchar(400) DEFAULT NULL,
  PRIMARY KEY (`id_problema`),
  KEY `id_funcionario` (`id_funcionario`),
  CONSTRAINT `problema_ibfk_1` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
...
INSERT INTO `problema` VALUES (50,'porta quebrada','Sala Ti',123,0,'Aberto',NULL,NULL,NULL,NULL,NULL,NULL);
